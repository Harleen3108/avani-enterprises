...
const LandingPageFree = () => {
    ...
    const fetchLeads = async () => {
        try {
            console.log("🔍 Fetching LandingPageFree leads with token:", token ? "Token exists" : "No token");
            ...
            setLoading(false);
            console.log("✅ LandingPageFree leads fetched successfully:", data.length);
        } catch (err) {
    ...
    const downloadExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "LandingPageFree");
        XLSX.writeFile(
            workbook,
            `Landing_Page_Free_Leads_${new Date().toISOString().split("T")[0]}.xlsx`
        );
    };
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">
                            Landing Page Free Leads
                        </h1>
                        <p className="text-gray-500 mt-1 text-sm md:text-base">
                            Manage free inquiry submissions from the Business Setup (Free) landing page.
                        </p>
                    </div>
...
export default LandingPageFree;
