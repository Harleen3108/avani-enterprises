...
const urls = [
  ...
  { loc: `${BASE_URL}/website-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/full-stack-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/shopify-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/woocommerce-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/custom-ecommerce-development`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/custom-crm-development`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/crm-software-development`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/crm-consulting-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/erp-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/custom-erp-development`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/erp-software-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/hrms-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/hr-software-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/attendance-management-software-development`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/payroll-software-development`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/business-operating-system-development`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/workflow-automation-software-development`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/ai-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/ai-chatbot-development`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/openai-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/claude-ai-development`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/gemini-ai-development`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/mcp-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/llm-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/ai-consulting-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/android-app-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/ios-app-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/flutter-app-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/react-native-development-company`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/seo-services`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/enterprise-seo-services`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/ecommerce-seo-services`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/performance-marketing-agency`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/facebook-ads-agency`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
  { loc: `${BASE_URL}/instagram-marketing-agency`, lastmod: TODAY, changefreq: "weekly", priority: "0.9" },
