...
const socialSyncPages = [
  ...
  { slug: 'social-media-management-tool', title: 'Multi-Channel Social Media Management Tool', feature: 'Management Tool', h1: 'Social Media Management Tool', desc: 'Manage your presence across Instagram, Facebook, X/Twitter, YouTube, and LinkedIn in one dashboard.' },
  { slug: 'social-media-scheduler', title: 'Social Media Content Scheduler', feature: 'Content Scheduler', h1: 'Social Media Scheduler', desc: 'Schedule and queue posts, reels, stories, and videos in advance using our drag-and-drop calendar.' },
  { slug: 'social-media-tool-for-agencies', title: 'Social Media Software for Agencies', feature: 'Agency Admin Desk', h1: 'Social Media Tool for Agencies', desc: 'Secure workspaces for client accounts, custom team permissions, approval logs, and white-label options.' },
  { slug: 'social-media-tool-for-creators', title: 'Social Media Scheduler for Creators', feature: 'Creator Toolkit', h1: 'Social Media Tool for Creators', desc: 'Automate Reels scheduling, capture engagement with auto DM replies, and manage channels on one calendar.' },
  { slug: 'social-media-tool-for-small-business', title: 'Social Media Tool for Small Business', feature: 'Small Business Social', h1: 'Social Media Tool for Small Business', desc: 'Grow your local reach without spending hours online. Schedule weekly posts and automate customer inquiries.' },
  { slug: 'social-media-management-for-enterprises', title: 'Enterprise Social Media Management Software', feature: 'Enterprise Workspaces', h1: 'Social Media Management for Enterprises', desc: 'High-security workspaces, multi-brand routing, strict editor approvals, and analytics tracking at scale.' },
  { slug: 'instagram-post-scheduler', title: 'Instagram Post & Reels Scheduler', feature: 'Instagram Scheduling', h1: 'Instagram Post & Reels Scheduler', desc: 'Direct auto-publishing for Instagram posts, reels, and stories, complete with auto DM comment triggers.' },
  { slug: 'instagram-reels-scheduler', title: 'Instagram Reels Scheduler Tool', feature: 'Reels Auto-Publish', h1: 'Instagram Reels Scheduler', desc: 'Queue and schedule vertical reels in advance with direct mobile publishing and comment monitoring.' },
  { slug: 'facebook-post-scheduler', title: 'Facebook Post & Story Scheduler', feature: 'Facebook Publishing', h1: 'Facebook Post & Story Scheduler', desc: 'Auto-publish images, link cards, and stories directly to Facebook pages and communities.' },
  { slug: 'facebook-story-scheduler', title: 'Facebook Story Scheduler Tool', feature: 'Facebook Stories', h1: 'Facebook Story Scheduler', desc: 'Draft and queue vertical story media to auto-publish on Facebook without manual alerts.' },
  { slug: 'linkedin-post-scheduler', title: 'LinkedIn Post Scheduler for Personal Brands', feature: 'LinkedIn Scheduling', h1: 'LinkedIn Post Scheduler', desc: 'Schedule PDF carousels, text thoughts, and video posts to build your founder profile on LinkedIn.' },
  { slug: 'youtube-video-scheduler', title: 'YouTube Shorts & Video Scheduler', feature: 'YouTube Uploads', h1: 'YouTube Video & Shorts Scheduler', desc: 'Queue long-form videos and shorts with title and description template inputs.' },
  { slug: 'twitter-post-scheduler', title: 'X / Twitter Post Scheduler Tool', feature: 'X/Twitter Threads', h1: 'X / Twitter Post Scheduler', desc: 'Schedule single posts and multi-part X threads, with media support and queue controls.' },
  { slug: 'multi-brand-social-media-management', title: 'Multi-Brand Social Media Software', feature: 'Multi-Brand Setup', h1: 'Multi-Brand Social Media Management', desc: 'Separate post calendars, team roles, and metrics dashboards for every brand in your portfolio.' },
  { slug: 'social-media-client-management', title: 'Social Media Client Approval Tool', feature: 'Client Approval Hub', h1: 'Social Media Client Management', desc: 'Share preview links with clients to collect feedbacks and approvals before posts go live.' },
  { slug: 'bulk-dm-tool', title: 'Instagram & Facebook Bulk DM Tool', feature: 'Bulk DM Broadcasts', h1: 'Instagram & Facebook Bulk DM Tool', desc: 'Send bulk direct messages to active leads and opt-in clients safely without flagging risk.' },
  { slug: 'auto-dm-tool', title: 'Instagram Auto DM Comment Trigger Tool', feature: 'Auto DM Triggers', h1: 'Instagram & Facebook Auto DM Tool', desc: 'Trigger instant DM replies containing product links when users comment specific keywords.' },
  { slug: 'social-media-content-planner', title: 'Social Media Content Planner Calendar', feature: 'Content Planner', h1: 'Social Media Content Planner', desc: 'Draft post ideas, schedule drafts, and plan campaigns visually on a shared content dashboard.' },
  { slug: 'social-media-approval-workflow', title: 'Social Media Post Approval Software', feature: 'Approval Workflows', h1: 'Social Media Approval Workflows', desc: 'Build review gates where writers submit drafts and designers attach media for admin sign-offs.' }
];
...
socialSyncPages.forEach(p => {
  data[p.slug] = {
    ...
    internalLinks: [
      ...
      { label: 'Instagram Scheduler', href: '/instagram-post-scheduler', desc: 'Auto-publish posts and reels.' },
      { label: 'LinkedIn Scheduler', href: '/linkedin-post-scheduler', desc: 'Founder brand scheduling.' },
      { label: 'Client Approvals', href: '/social-media-client-management', desc: 'Preview portals for clients.' }
    ],
    cta: {
