...
const STATIC_FALLBACK: Record<string, Pick<SeoData, 'title' | 'metaDescription' | 'metaKeywords'>> = {
  ...
  "/payroll-software-india": {
    ...
    metaDescription: "Automated payroll software for India with PF, ESI, TDS compliance and instant payslips. Custom-built for your company. 8+ years, 5.0 rating. Get a quote.",
