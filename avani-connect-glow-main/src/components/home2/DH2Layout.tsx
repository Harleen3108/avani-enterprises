...
const footerLinks = {
  company: [
    { label: 'About Us', path: '/home2/about' },
    { label: 'Careers', path: '/home2/careers' },
    { label: 'Case Studies', path: '/home2/case-studies' },
    { label: 'Blog', path: '/home2/blog' },
  ],
  services: [
    { label: 'Ready Products', path: '/home2/our-products' },
    { label: 'Expertise', path: '/home2/services' },
    { label: 'Newsletters', path: '/home2/newsletters' },
    { label: 'Global Network', path: '/home2/global-presence' },
    { label: 'Contact', path: '/home2/contact' },
  ],
  legal: [
    { label: 'Privacy Policy', path: '/home2/privacy-policy' },
    { label: 'Terms & Conditions', path: '/home2/terms-and-conditions' },
  ],
};
...
const DH2Layout = () => {
  ...
  // Theme interpolation (same as Home2)
