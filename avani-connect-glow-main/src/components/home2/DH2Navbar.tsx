...
const DH2Navbar = () => {
  ...
  const navItems = [
    ...
    { name: 'About', path: '/home2/about' },
    {
      name: 'Services',
      path: '/home2/services',
      dropdown: [
        { name: 'All Services', path: '/home2/services' },
        { name: 'Web & App Development', path: '/home2/services/web-app-development' },
        { name: 'SEO & Content Marketing', path: '/home2/services/seo-content-marketing' },
        { name: 'Social Media Marketing', path: '/home2/services/social-media-marketing' },
        { name: 'AI Solutions', path: '/home2/services/ai-solutions' },
        { name: 'Podcast Production', path: '/home2/services/podcast-production' },
        { name: 'Financial Consulting', path: '/home2/services/financial-consulting' }
      ]
    },
    {
      name: 'Our Products',
      path: '/home2/our-products',
      subItems: [
        { name: 'Avani Business OS', path: '/home2/our-products', external: 'https://os.avanienterprises.in' },
        { name: 'School Management', path: '/home2/our-products', external: 'https://indus-school-page.vercel.app/admission' },
        { name: 'Project CRM', path: '/home2/our-products', external: 'https://team-lead-gamma.vercel.app/' },
        { name: 'Custom E-commerce', path: '/home2/our-products', external: 'https://shoes-ecommerce-iota.vercel.app/' },
      ]
    },
    {
      name: 'Resources',
      dropdown: [
        { name: 'Blog', path: '/home2/blog' },
        { name: 'Newsletters', path: '/home2/newsletters' },
        { name: 'Courses', path: '/home2/courses' },
        { name: 'Case Studies', path: '/home2/case-studies' },
      ]
    },
    { name: 'Careers', path: '/home2/careers' },
    { name: 'Global Presence', path: '/home2/global-presence' },
    { name: 'Contact', path: '/home2/contact' },
  ];

  const isActive = (path: string) => location.pathname === path;
  const isDropdownActive = (items: { path: string }[]) => items.some(i => location.pathname === i.path);
  const isHomePage = location.pathname === '/home2' || location.pathname === '/home2/';

  return (
    <nav className={`dh2-nav ${scrolled ? 'dh2-nav--scrolled' : ''} ${!scrolled && isHomePage ? 'dh2-nav--transparent' : ''}`}>
      <Link to="/home2" className="dh2-logo">AVANI.</Link>
