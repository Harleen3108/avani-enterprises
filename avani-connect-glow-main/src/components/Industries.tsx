...
const DummyIndustries = () => {
  return (
    <section className="theme-brown" style={{ padding: '40px 0', background: 'var(--bg-primary)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 5 }}>
        ...
        >
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '15px', color: 'var(--text-secondary)', maxWidth: '500px', margin: '16px auto 0', fontWeight: 400, lineHeight: 1.6 }}>
