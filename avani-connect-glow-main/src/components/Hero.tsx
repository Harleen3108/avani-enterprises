...
import DummyAnimatedCounter from './AnimatedCounter';
...
const AmbientParticles = () => {
  ...
  return (
    <div className="dummy-hero-particles" style={{ position: 'absolute', inset: 0, zIndex: 3, pointerEvents: 'none', overflow: 'hidden' }}>
      {particles.map(p => (
        <motion.div
          key={p.id}
          animate={{
