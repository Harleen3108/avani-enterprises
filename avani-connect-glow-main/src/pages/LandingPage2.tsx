  ...
  return (
    <>
      <style>{`
        ...
        .bb-discount { font-family: 'Plus Jakarta Sans', sans-serif; font-size: 13px; font-weight: 800; color: #DC2626; background: rgba(220, 38, 38, 0.1); padding: 2px 6px; border-radius: 4px; letter-spacing: 0.5px; }
      ...
      <div className="bottom-bar">
        <div className="bottom-bar-inner">
          ...
          <div className="bb-hook">
            <span className="bb-price-old">₹2000</span>
            <span className="bb-price-new">₹149</span>
            <span className="bb-discount">92% OFF</span>
          </div>
          {/* Divider */}
...
export default function BusinessSetup2() {
  ...
  // Scroll to the inquiry form placed in the hero section
  const scrollToForm = () => {
  ...
  const testimonials = [
    { name: "Rahul Mehta", role: "E-commerce Founder", text: "Initially skeptical about the ₹499 audit, but the growth roadmap was a game-changer. We went from 0 to 42 leads/month in just 3 months.", stars: 5, image: "/review_person1.webp" },
    { name: "Priya Sharma", role: "CMO, TextileBridge", text: "The strategy session alone was worth 10X the price. They identified 3 major leaks in our homepage that were costing us lakhs.", stars: 5, image: "/review_person2.webp" },
    { name: "Vikram Nair", role: "Business Owner", text: "Finally, a agency that talks numbers, not just aesthetics. The step-by-step lead gen plan is exactly what I needed to scale.", stars: 5, image: "/review_person3.webp" },
  ];
    ...
    <div style={{ background: C.dark, color: C.text, fontFamily: "'Plus Jakarta Sans', sans-serif", overflowX: "hidden" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes offerGlow { 0%,100% { box-shadow: 0 0 0 0 rgba(212,160,23,0.45); } 50% { box-shadow: 0 0 0 7px rgba(212,160,23,0); } }
        .nav-offer-btn:hover { transform: translateY(-1px); }
        ...
        /* NOTE: global input/select/textarea overrides were removed here so the
           embedded RegistrationForm keeps its own icon padding & alignment. */
        ...
        @media (max-width: 1024px) {
          ...
          /* ── Hero Mobile (form-first, prominent) ── */
          .hero-grid { display: flex !important; flex-direction: column !important; grid-template-columns: 1fr !important; gap: 26px !important; text-align: center; }
          .hero-text-content { align-items: center !important; order: 2 !important; }
          ...
          .hero-form-col { order: 1 !important; width: 100% !important; margin: 0 auto !important; }
          .hero-form-col > div:first-child { display: none !important; }
      ...
      <nav style={{
        ...
        <div className="nav-links" style={{ display: "flex", gap: "30px", alignItems: "center" }}>
          ...
          <button
            ...
            className="nav-desktop-cta nav-offer-btn"
            style={{
              display: "flex", alignItems: "center", gap: "8px",
              marginLeft: "10px", padding: "8px 16px", borderRadius: "8px",
      ...
      <section className="hero-section" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 6%", position: "relative", overflow: "hidden" }}>
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 1, maxWidth: "1400px", width: "100%", marginTop: "80px" }}>
          <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: "80px", alignItems: "start" }}>
            ...
            {/* Right Column: Inquiry Form (visible immediately on page load) */}
      ...
      <section id="pricing" className="mobile-section" style={{ padding: "80px 6%", background: `linear-gradient(180deg, ${C.dark} 0%, #F0F0EC 50%, ${C.dark} 100%)`, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
                    ...
                    <td key={i} style={{ 
                      ...
                      >
                        <span className="btn-book-now" style={{ fontSize: "14px", fontWeight: 800, letterSpacing: "0.5px" }}>
                          <span className="btn-book">Get</span> Started
                        </span>
                        <span className="btn-slot" style={{ fontSize: "11px", fontWeight: 600, opacity: 0.9 }}>Free Consultation</span>
                      </button>
                    </td>
                  ))}
                </tr>
          ...
          <p style={{ textAlign: "center", marginTop: "40px", color: C.muted, fontSize: "12px", letterSpacing: "0.5px", fontWeight: 400 }}>
            Share your details and our team will reach out to plan the right fit for your business — no payment required.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <div className="ai-cta-row" style={{ display: "flex", justifyContent: "center", gap: "16px" }}>
              <button onClick={() => scrollToForm()} className="cta-btn" style={{
                padding: "18px 40px",
                fontSize: "13px",
                display: "flex",
                alignItems: "center",
