...
import DH2EcosystemMap from '../../components/home2/DH2EcosystemMap';
            ...
            <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
              ...
              <motion.div variants={fadeUp} style={{ maxWidth: '600px' }}>
                ...
                <div style={{ display: 'flex', gap: '1.5rem' }}>
                  <Link to="/home2/contact" className="dh2-btn-fill">Work With Us <ArrowRight size={16} /></Link>
      ...
      <section className="dh2-cta">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} style={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center' }}>
            <Link to="/home2/contact" className="dh2-btn-fill">Start Project <ArrowRight size={16} /></Link>
            <Link to="/home2/careers" className="dh2-btn-ghost">Join the Team</Link>
          </div>
        </motion.div>
      </section>
