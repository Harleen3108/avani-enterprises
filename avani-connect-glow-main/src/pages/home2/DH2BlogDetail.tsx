  ...
  if (!blog) {
    return (
      <div className="dh2-page" style={{ minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Link to="/home2/blog" className="dh2-btn-ghost" style={{ marginTop: '2rem' }}>Return to Blog <ArrowLeft size={14} /></Link>
      </div>
    );
  }
      ...
      <section className="dh2-section" style={{ paddingTop: '8rem', paddingBottom: '3rem', background: 'var(--bg-surface)', borderBottom: '1px solid var(--border-s)' }}>
        <div className="dh2-container" style={{ maxWidth: '800px', margin: '0 auto' }}>
          <motion.div initial="hidden" animate="visible" variants={fadeIn}>
            <Link to="/home2/blog" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-dim)', fontSize: '0.8rem', textDecoration: 'none', fontWeight: 600, marginBottom: '2rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
