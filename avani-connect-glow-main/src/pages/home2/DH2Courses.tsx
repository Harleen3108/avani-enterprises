    ...
    <div className="dh2-page">
                  ...
                  <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border-s)', borderRadius: 16, overflow: 'hidden', height: '100%', display: 'flex', flexDirection: 'column', transition: 'border-color .3s, transform .3s' }}
                    ...
                    <div style={{ padding: '2rem', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                      ...
                      <div style={{ display: 'flex', gap: '.5rem' }}>
                        <Link to={`/home2/courses/${course.id}`} style={{ flex: 1, padding: '.8rem', background: 'transparent', border: '1px solid var(--accent)', color: 'var(--accent)', borderRadius: 8, fontSize: '.65rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '.1em', cursor: 'pointer', textDecoration: 'none', textAlign: 'center' }}>Details</Link>
      ...
      <section className="dh2-cta">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn} transition={{ delay: .2 }} style={{ display: 'flex', gap: '1rem', justifyContent: 'center', position: 'relative', zIndex: 1 }}>
          <Link to="/home2/contact" className="dh2-btn-fill">Get Consultation</Link>
          <a href="tel:+91 84487 63134" className="dh2-btn-ghost">Talk to Expert</a>
        </motion.div>
      </section>
    </div>
  );
